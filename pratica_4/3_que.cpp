...
* Description:  Implemente funções insert_rear(l,x), para inserir um elemento no final da lista e remove_front(l,x) para retirar um elemento do início da lista "l", de forma que ela seja tratada como uma fila
